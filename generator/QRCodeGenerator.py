...
class QRCodeGenerator:
    ...
    def generate(self, n = 5, fgColor=(0, 0, 0), bgColor=(255, 255, 255)) -> None:
        if n <= 0:
            n = 5
        ...
        for _ in range(n):
            ...
            cv2.imwrite("./images/qrcode{}.png".format(_), qr_array)
        
        return
    
if __name__ == "__main__":
    generator = QRCodeGenerator(24)
    generator.generate(5, (123, 253, 97), (123, 123, 123))
